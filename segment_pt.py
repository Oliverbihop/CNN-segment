...
class Net(nn.Module):
    def __init__(self):
        ...
        self.convtran1 = nn.ConvTranspose2d(64, 64, 2, stride=2, padding=0)

        self.conv9 = nn.Conv2d(96, 32, 3, stride=1, padding=1)
        self.conv10 = nn.Conv2d(32, 32, 3, stride=1, padding=1)

        self.convtran2 = nn.ConvTranspose2d(32, 32, 2, stride=2, padding=0)

        self.conv11 = nn.Conv2d(48, 16, 3, stride=1, padding=1)
        self.conv12 = nn.Conv2d(16, 16, 3, stride=1, padding=1)

        self.convtran3 = nn.ConvTranspose2d(16, 16, 2, stride=2, padding=0)

        self.conv13 = nn.Conv2d(24, 8, 3, stride=1, padding=1)
        self.conv14 = nn.Conv2d(8, 8, 3, stride=1, padding=1)

        self.conv15 = nn.Conv2d(8, 1, 1)
